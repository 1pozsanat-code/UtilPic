...
export const FaceSwapIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21a3 3 0 0 0 3-3v-2.25a3 3 0 0 1 3-3h.015a3 3 0 0 1 3 3V18a3 3 0 0 0 3 3" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 10.5h.015" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 10.5h-1.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.5 6 12l3-1.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="m3 13.5 1.5-1.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 13.5 18 12l-3-1.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="m21 13.5-1.5-1.5" />
    </svg>
);
...
export const DoubleExposureIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.28 5.222a2.25 2.25 0 0 1 2.25-2.25h9.75a2.25 2.25 0 0 1 2.25 2.25v9.75a2.25 2.25 0 0 1-2.25 2.25h-2.134" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 10.5a2.25 2.25 0 0 0-2.25-2.25H3.75a2.25 2.25 0 0 0-2.25 2.25v9.75a2.25 2.25 0 0 0 2.25 2.25h9.75a2.25 2.25 0 0 0 2.25-2.25v-2.134" />
    </svg>
);
...
export const GrainIcon: React.FC<{ className?: string }> = ({ className }) => (
    // FIX: Corrected syntax error in strokeWidth property
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const SplitScreenIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
